...
from src.reporter.pdf import PDF
...
class Agent:
    ...
    def make_decision(self, prompt: str, project_name: str) -> str:
        ...
        for item in decision:
            ...
            ProjectManager().add_message_from_kevin(project_name, reply)
            ...
            if function == "git_clone":
                ...
                ProjectManager().add_message_from_kevin(project_name, response)
    ...
    def subsequent_execute(self, prompt: str, project_name: str) -> str:
        ...
        code_markdown = SimpleCodeReader(project_name).code_set_to_markdown()
    ...
    def execute(self, prompt: str, project_name_from_user: str = None, web_search: str = None) -> str:
        ...
        ProjectManager().add_message_from_kevin(project_name, reply)
        ProjectManager().add_message_from_kevin(project_name, json.dumps(plans, indent=4))
        # ProjectManager().add_message_from_kevin(project_name, f"In summary: {summary}")
        ...
        ProjectManager().add_message_from_kevin(
            project_name,
        ...
        if ask_user != "":
            ProjectManager().add_message_from_kevin(project_name, ask_user)
            AgentState().set_agent_active(project_name, False)
            ...
            while not got_user_query:
                ...
                if latest_message_from_user and validate_last_message_is_from_user:
                    ...
                    got_user_query = True
                    ProjectManager().add_message_from_kevin(project_name, "Thanks! 🙌")
                time.sleep(5)
        ...
        ProjectManager().add_message_from_kevin(project_name, "I have completed the coding task. You can now run the project.")
